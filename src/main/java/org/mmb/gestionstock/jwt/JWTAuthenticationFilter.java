package org.mmb.gestionstock.jwt;
...
import org.mmb.gestionstock.GestionstockApplication;
import org.mmb.gestionstock.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = GestionstockApplication.getCtx().getBean(UserService.class);

        org.mmb.gestionstock.bean.User myUser = userService.findByUsernameWithRoles(user.getUsername());
